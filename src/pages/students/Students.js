...
import StudentsMainSection from '../../components/students/StudentsMainSection'
...
const Students = () => {
  ...
  return (
    <div
      ...
      <div className='flex flex-row justify-between pt-20  min-h-screen'>
        <div className='bg-[#161F2B] w-full px-24'>
          <StudentsMainSection

...
import ProductsMainSection from '../../components/products/ProductsMainSection'
...
const Products = () => {
  ...
  return (
    <div className='flex bg-[#161F2B] flex-col min-h-screen'>
      <div className='fixed top-0 w-full  backdrop-blur-sm'>
        <Navbar />
      </div>
      <div className='flex flex-row justify-between w-full h-full'>
        <div className='bg-[#161F2B] w-full pt-24'>
          <ProductsMainSection activeSection={activeSection} />
        </div>

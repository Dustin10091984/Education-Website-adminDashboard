...
import TemplatesIndexCourseMainSection from '../../components/templatesIndexCourse/TemplatesIndexCourseMainSection'

const TemplatesIndexCourse = () => {
    ...
    <div className='flex flex-col bg-[#161F2B] min-h-screen'>
      ...
      <div className='pt-24 flex flex-row justify-between  w-full h-full'>
        <div className='bg-[#161F2B] w-screen px-24 m-2'>
          <TemplatesIndexCourseMainSection activeSection={activeSection} />
        </div>
...
export default TemplatesIndexCourse

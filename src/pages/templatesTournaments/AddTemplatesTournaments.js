...
import { addTemplatesTournaments } from '../../features/templatesTournaments/templatesTournamentsSlice'

const AddTemplatesTournaments = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(addTemplatesTournaments(newTemplateData))
      .unwrap()
  ...
  return (
    <div className='flex justify-center items-center max-w-7xl mx-auto p-5 h-screen'>
      ...
      >
        <h1 className='mb-4 font-extrabold'>اضافه کردن تورنومنت</h1>
        {/* file input */}
...
export default AddTemplatesTournaments

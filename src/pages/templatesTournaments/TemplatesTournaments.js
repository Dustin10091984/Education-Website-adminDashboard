...
import TemplatesTournamentsMainSection from '../../components/templatesTournaments/TemplatesTournamentsMainSection'

const TemplatesTournaments = () => {
    ...
    <div className='flex flex-col bg-[#161F2B] min-h-screen'>
      ...
      <div className='pt-24 flex flex-row justify-between  w-full h-full'>
        <div className='bg-[#161F2B] w-screen px-24 m-2'>
          <TemplatesTournamentsMainSection activeSection={activeSection} />
        </div>
...
export default TemplatesTournaments

...
import { addTemplatesQuestions } from '../../features/templatesQuestions/templatesQuestionsSlice'

const AddTemplatesQuestions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(addTemplatesQuestions(newTemplateData))
      .unwrap()
...
export default AddTemplatesQuestions

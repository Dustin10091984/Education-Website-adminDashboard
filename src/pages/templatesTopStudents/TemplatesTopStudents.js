...
import TemplatesTopStudentsMainSection from '../../components/templatesTopStudents/TemplatesTopStudentsMainSection'

const TemplatesTopStudents = () => {
    ...
    <div className='flex flex-col bg-[#161F2B] min-h-screen'>
      ...
      <div className='pt-24 flex flex-row justify-between  w-full h-full'>
        <div className='bg-[#161F2B] w-screen px-24 m-2'>
          <TemplatesTopStudentsMainSection activeSection={activeSection} />
        </div>
...
export default TemplatesTopStudents
